...
\usetikzlibrary{arrows.meta,positioning,shapes.geometric,calc,fit,
                 decorations.pathreplacing,decorations.pathmorphing,backgrounds,matrix}
...
\usepackage{caption}            % for \captionof in TikZ figures
\usepackage{pgfplots}           % for data-driven charts
\pgfplotsset{compat=1.18}

% Checkmark for tables
...
% Part VI: Reference and Deployment
\part{Reference and Deployment}
\input{chapters/ch16-dependencies}
\input{chapters/ch17-codebase}
\input{chapters/ch18-testing}
\input{chapters/ch19-benchmarks}
\input{chapters/ch20-deployment}

% Part VII: Deep Dives and Analysis
\part{Deep Dives and Analysis}
\input{chapters/ch21-related-work}
\input{chapters/ch22-protocol-specification}
\input{chapters/ch23-api-reference}
\input{chapters/ch24-threat-modeling}
\input{chapters/ch25-performance-analysis}
